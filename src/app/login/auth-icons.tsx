...
export function GoogleIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24">
      <path
        fill="#4285F4"
        d="M23.745 12.27c0-.7-.06-1.4-.19-2.07H12v4.51h6.6c-.29 1.52-1.14 2.8-2.4 3.67v3.05h3.87c2.26-2.09 3.675-5.17 3.675-9.16z"
      />
      <path
        fill="#34A853"
...
export function EmailBadgeIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <div className={`${className} rounded-[6px] bg-[#e11d48] flex items-center justify-center shadow-xs flex-shrink-0`}>
